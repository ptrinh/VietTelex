...
final class EngineGoldenTests: XCTestCase {
    ...
    // "Bỏ dấu tự do" toggle (OpenKey issue #224). Default (strict / Minimal Telex):
    ...
    // Marks become order-free like OpenKey — w typed AFTER the a still lands on u.
    ...
    // Simple Telex (OpenKey #223): a standalone w is ALWAYS literal — type `uw` for ư.
